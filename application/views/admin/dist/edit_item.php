                        ...
                        <div class="movement_form">
                            ...
                            <form action="/items/edit/(:any)/validate" method="post">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md">
                                        <div class="col-md-4 input-group input-group-outline my-1">
                                            <input type="text" name="itemname" class="form-control" placeholder="Item Name" value="<?=$details['name']?>">
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="col-md-4 input-group input-group-outline my-1">
                                    ...
                                    <div class="col-md">
                                        <div class="col-md-4 input-group input-group-outline my-1">
                                            <input type="text" name="unitcost" class="form-control" placeholder="Unit Cost(10.00)"  value="<?=$details['unit_price']?>">
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="col-md-4 input-group input-group-outline my-1">
